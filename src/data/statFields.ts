...
export const STAT_FIELDS: StatField[] = [
  ...
  { key: "MATK",        label: "MATK (non-weapon)", target: "gear", pct: false, group: "Flat" },
  { key: "WeaponMATK",  label: "Main Weapon MATK", target: "gear", pct: false, group: "Flat" },
  { key: "OffhandMATK", label: "Offhand MATK",     target: "gear", pct: false, group: "Flat" },
